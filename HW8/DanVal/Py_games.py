...
RULE_X = WIDTH_DISPLAY - WIDTH_RECTANGLE - DELTA_STEP
RULE_Y = HEIGHT_DISPLAY - HEIGHT_RECTANGLE - DELTA_STEP
...
while run:
    ...
    if keys[pygame.K_RIGHT] and COORD_X < RULE_X:
        COORD_X = COORD_X + DELTA_STEP
    if keys[pygame.K_UP] and COORD_Y > DELTA_STEP:
        COORD_Y = COORD_Y - DELTA_STEP
    if keys[pygame.K_DOWN] and COORD_Y < RULE_Y:
        COORD_Y = COORD_Y + DELTA_STEP
